...
- Zod 3.
- Axios 1.
- Componentes estilo shadcn/ui con Radix Slot, CVA y utilidades `cn`.
- Vitest 3.
...
Las pruebas E2E usan Playwright y mockean la API desde el navegador. Si Playwright fue instalado por primera vez, ejecutar:
